...
from zkl_quantum_circuit.basics import QOperation, QSystemStruct
from zkl_quantum_circuit.operations import Remapped, Sequential
from zkl_quantum_circuit.traits import compile, match_apply_impls, register_compile_impl
...
def args_from_signature(op: QOperation) -> QSystemStruct:
    ...
    from zkl_quantum_circuit.traits_impls import SymbolicParticle
...
def common_impl(ps: FreezePass, op: QOperation) -> QOperation:
    ...
    calls = None
    from zkl_quantum_circuit.traits_impls import SymbolicRuntime
