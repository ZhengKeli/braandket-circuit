...
from zkl_quantum_circuit.traits.utils import resolve_type_and_instance
...
def register_compile_impl(
    ...
    _registry.register({PsType: ps_type, PsInst: ps_inst, OpType: op_type, OpInst: op_inst}, impl)
    return impl
